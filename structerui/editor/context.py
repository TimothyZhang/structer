    ...
    def __init__(self, project, objects, readonly=False):
        ...
        if type(objects) is list:
            ...
            for obj in objects:
                ...
                data['__uuid__'] = obj.uuid     # use this hidden value to locate which object this data belongs to
...
#         return self._objects
    ...
    def is_modified(self):        
        cmp = self.clazz.atstruct.compare
        ...
        if self.is_batch():
            ...
            for data in self.attr_data:
                ...
                if not obj:
                    return True
                if cmp(data, obj.raw_data)!=0:
                    return True            
            return False
        
        else:
            return cmp(self.attr_data, self._objects.raw_data)!=0            
