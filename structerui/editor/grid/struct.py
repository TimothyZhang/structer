...
class StructGrid(GridBase):
    ...
    def make_copy_data(self, block):
        ...
        tbl = self.GetTable()
        attr_type_names = [tbl.get_attr_type(row, 2).name for row in xrange(top, bottom+1)]
